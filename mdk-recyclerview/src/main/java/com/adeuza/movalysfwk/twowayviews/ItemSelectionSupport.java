...
public class ItemSelectionSupport {
    ...
    public static final int twowayview_item_selection_support_tag = "twowayview_item_selection_support".hashCode();
    ...
    public static ItemSelectionSupport addTo(RecyclerView recyclerView) {
        ...
        if (itemSelectionSupport == null) {
            ...
            recyclerView.setTag(twowayview_item_selection_support_tag, itemSelectionSupport);
        } else {
            // TODO: Log warning
        }
    ...
    public static void removeFrom(RecyclerView recyclerView) {
        ...
        recyclerView.setTag(twowayview_item_selection_support_tag, null);
    }
    ...
    public static ItemSelectionSupport from(RecyclerView recyclerView) {
        ...
        return (ItemSelectionSupport) recyclerView.getTag(twowayview_item_selection_support_tag);
    }
