...
public class MMActionImageButton extends MMImageButton implements OnClickListener {
	 ...
	 * @param p_oAttrs the android view attribute (in layout XML)
	...
	/**
	 * Read class from attributes
	 * @param p_oAttrs the attribute set to read
	 * @param p_sAttributeName the attribute name to read
	 * @return the class in attribute if exists
	 */
	...
	/**
	 * read method form attributes
	 * @param p_oAttrs the attribute set to read
	 * @return the method to call on click if exists
	 */
