...
import com.adeuza.movalysfwk.mobile.mf4android.ui.views.MMDoublePicker;
...
public class MMDoublePickerDialogFragment extends MMDialogFragment implements OnClickListener, OnDateChangedListener, OnDismissListener {
	 ...
	 * The temporary value for this dialog
	 */
	public MMDoublePicker m_uiDoublePicker = null;
	...
	public Dialog onCreateDialog(Bundle p_oSavedInstanceState) {
		...
		m_uiDoublePicker = (MMDoublePicker) o_uiContentView.findViewById(oApplication.getAndroidIdByRKey(AndroidApplicationR.component_doublepicker__picker));
		m_uiDoublePicker.getComponentDelegate().configurationSetValue(m_dTemporaryValue);
		m_uiDoublePicker.getComponentDelegate().configurationEnabledComponent() ;
	...
	private void onValidateClick() {
		this.m_dTemporaryValue = m_uiDoublePicker.getComponentDelegate().configurationGetValue();
	}
