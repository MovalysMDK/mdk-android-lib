...
public abstract class MCipherOpenHelper {
     ...
     * @throws net.sqlcipher.database.SQLiteException if the database cannot be opened for writing
     ...
     *
     * @param p_sPassword a {@link java.lang.String} object.
     * @throws net.sqlcipher.database.SQLiteException if the database cannot be opened
     ...
     * Override method should check {@link net.sqlcipher.database.SQLiteDatabase#isReadOnly} before
