...
public class AndroidCipherSQLiteOpenHelperImpl extends MCipherOpenHelper
	...
	public void myOnOpen(AndroidSQLiteDatabase<SQLiteDatabase> p_oDb) {
		if (p_oDb instanceof SQLiteDatabase) {
	...
	public void myOnCreate(AndroidSQLiteDatabase<SQLiteDatabase> p_oSQLiteDatabase) {
		if (p_oSQLiteDatabase instanceof SQLiteDatabase) {
	...
	/**
	 * Resets the database given in parameters
	 * @param p_oSQLiteDatabase the database to reset
	 */
	...
	/**
	 * Creates the schema of the database described in the {@link DBUpdaterService}
	 * @param p_oSQLiteDatabase the database to create the schema on
	 */
