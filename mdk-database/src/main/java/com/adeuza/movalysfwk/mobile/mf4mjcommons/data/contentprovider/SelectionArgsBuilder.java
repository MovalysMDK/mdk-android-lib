...
public class SelectionArgsBuilder {
	 ...
	 */
	public void addValue( Object p_oValue, @SqlType int p_iSqlType ) {
		int iTargetSqlType = p_iSqlType;
		if(p_iSqlType == Types.NUMERIC && !Long.class.isAssignableFrom(p_oValue.getClass())){
			iTargetSqlType = Types.INTEGER; 
		}
		
		if(p_iSqlType == Types.DECIMAL){
