...
public class SqlCompareValueCondition extends AbstractSqlCondition implements Cloneable {
	 ...
	 *
	 * @param p_oField champs pour l'égalité
	 * @param p_operator a {@link com.adeuza.movalysfwk.mobile.mf4mjcommons.data.dao.query.conditions.OperatorCondition} object.
	 */
	public SqlCompareValueCondition( Field p_oField, OperatorCondition p_operator ) {
	 ...
	 * @param p_operator a {@link com.adeuza.movalysfwk.mobile.mf4mjcommons.data.dao.query.conditions.OperatorCondition} object.
	 */
	public SqlCompareValueCondition( SqlField p_oField, SqlBindValue p_oValue, OperatorCondition p_operator ) {
		this.field = p_oField;
		this.value = p_oValue ;
		this.operator = p_operator;
	}
	 ...
	 */
	public SqlCompareValueCondition( SqlField p_oField, SqlType p_oSqlType) {
		this(p_oField, p_oSqlType, OperatorCondition.EQUALS);
	}
	 ...
	 * @param p_operator a {@link com.adeuza.movalysfwk.mobile.mf4mjcommons.data.dao.query.conditions.OperatorCondition} object.
	 */
	public SqlCompareValueCondition( SqlField p_oField, SqlType p_oSqlType, OperatorCondition p_operator ) {
		this.field = p_oField;
	 ...
	 * @param p_oSqlType type de la valeur
	 */
	public SqlCompareValueCondition( String p_sFieldName, SqlType p_oSqlType) {
		this(p_sFieldName, p_oSqlType, OperatorCondition.EQUALS);
	}
	 ...
	 * @param p_operator a {@link com.adeuza.movalysfwk.mobile.mf4mjcommons.data.dao.query.conditions.OperatorCondition} object.
	 */
	public SqlCompareValueCondition( String p_sFieldName, SqlType p_oSqlType, OperatorCondition p_operator ) {
	...
	/**
	 * Constructeur avec nom du champs, type de la valeur, type de liaison et opérateur =
	 *
	 * @param p_sFieldName nom du champs
	 * @param p_oSqlType type SQL de la valeur
	 * @param p_oSqlClauseLink liaison avec l'ancienne clause
	 */
	public SqlCompareValueCondition( String p_sFieldName, SqlType p_oSqlType, SqlClauseLink p_oSqlClauseLink) {
		this(p_sFieldName, p_oSqlType, p_oSqlClauseLink, OperatorCondition.EQUALS);
	}
	 ...
	 * @param p_operator a {@link com.adeuza.movalysfwk.mobile.mf4mjcommons.data.dao.query.conditions.OperatorCondition} object.
	 */
	public SqlCompareValueCondition( String p_sFieldName, SqlType p_oSqlType, SqlClauseLink p_oSqlClauseLink, OperatorCondition p_operator ) {
		this.field = new SqlField(p_sFieldName);
	 ...
	 * @param p_oSqlType type de la valeur
	 */
	public SqlCompareValueCondition( String p_sFieldName, Object p_oValue, SqlType p_oSqlType) {
		this(p_sFieldName, p_oValue, p_oSqlType, OperatorCondition.EQUALS);
	}
	 ...
	 * @param p_operator a {@link com.adeuza.movalysfwk.mobile.mf4mjcommons.data.dao.query.conditions.OperatorCondition} object.
	 */
	public SqlCompareValueCondition( String p_sFieldName, Object p_oValue, SqlType p_oSqlType, OperatorCondition p_operator ) {
		this.field = new SqlField(p_sFieldName);
	...
	/**
	 * Constructeur avec nom du champs, valeur, type de la valeur et liaison avec l'ancienne clause et opérateur =
	 *
	 * @param p_sFieldName nom du champs
	 ...
	 * @param p_oSqlClauseLink liaison avec l'ancienne clause
	 */
	public SqlCompareValueCondition( String p_sFieldName, Object p_oValue, SqlType p_oSqlType, SqlClauseLink p_oSqlClauseLink) {
		this(p_sFieldName, p_oValue, p_oSqlType, p_oSqlClauseLink, OperatorCondition.EQUALS);
	}
	 ...
	 * @param p_operator a {@link com.adeuza.movalysfwk.mobile.mf4mjcommons.data.dao.query.conditions.OperatorCondition} object.
	 */
	public SqlCompareValueCondition( String p_sFieldName, Object p_oValue, SqlType p_oSqlType, SqlClauseLink p_oSqlClauseLink, OperatorCondition p_operator ) {
		this.field = new SqlField(p_sFieldName);
		this.value = new SqlBindValue(p_oValue, p_oSqlType) ;
		setLink(p_oSqlClauseLink);
		this.operator = p_operator;
	 ...
	 */
	public SqlCompareValueCondition( String p_sFieldName, String p_sAlias, Object p_oValue, SqlType p_oSqlType) {
		this(p_sFieldName, p_sAlias, p_oValue, p_oSqlType, OperatorCondition.EQUALS);
	}
	...
	/**
	 * Constructeur avec nom du champs, alias de la table du champs, type de la valeur et liaison avec l'ancienne clause et opérateur =
	 *
	 * @param p_sFieldName nom du champs
	 * @param p_sAlias alias de la table du champs
	 * @param p_oSqlType type SQL du champs
	 ...
	 */
	public SqlCompareValueCondition( String p_sFieldName, String p_sAlias, Object p_oValue, SqlType p_oSqlType, 
			SqlClauseLink p_oSqlClauseLink) {
		this(p_sFieldName, p_sAlias, p_oValue, p_oSqlType, p_oSqlClauseLink, OperatorCondition.EQUALS);
	}
	 ...
	 */
	public SqlCompareValueCondition( String p_sFieldName, String p_sAlias, Object p_oValue, SqlType p_oSqlType, 
			SqlClauseLink p_oSqlClauseLink, OperatorCondition p_operator ) {
		this.field = new SqlField(p_sFieldName, p_sAlias);
		setLink(p_oSqlClauseLink);
		this.value = new SqlBindValue(p_oValue, p_oSqlType) ;
		this.operator = p_operator;
	 ...
	 * @param p_oSqlType type SQL du champs
	 */
	public SqlCompareValueCondition( String p_sFieldName, String p_sAlias, SqlType p_oSqlType) {
		this(p_sFieldName, p_sAlias, p_oSqlType, OperatorCondition.EQUALS);
	}
	 ...
	 * @param p_operator a {@link com.adeuza.movalysfwk.mobile.mf4mjcommons.data.dao.query.conditions.OperatorCondition} object.
	 */
	public SqlCompareValueCondition( String p_sFieldName, String p_sAlias, SqlType p_oSqlType, OperatorCondition p_operator ) {
		this.field = new SqlField(p_sFieldName, p_sAlias);
		this.value = new SqlBindValue(null, p_oSqlType) ;
		this.operator = p_operator;
	}
	 ...
	 * @param p_oSqlClauseLink liaison avec l'ancienne clause
	 */
	public SqlCompareValueCondition( String p_sFieldName, String p_sAlias, SqlType p_oSqlType, SqlClauseLink p_oSqlClauseLink) {
		this(p_sFieldName, p_sAlias, p_oSqlType, p_oSqlClauseLink, OperatorCondition.EQUALS);
	}
	 ...
	 * @param p_operator a {@link com.adeuza.movalysfwk.mobile.mf4mjcommons.data.dao.query.conditions.OperatorCondition} object.
	 */
	public SqlCompareValueCondition( String p_sFieldName, String p_sAlias, SqlType p_oSqlType, SqlClauseLink p_oSqlClauseLink, OperatorCondition p_operator ) {
		this.field = new SqlField(p_sFieldName, p_sAlias);
		setLink(p_oSqlClauseLink);
		this.value = new SqlBindValue(null, p_oSqlType) ;
		this.operator = p_operator;
	 ...
	 * @param p_oSqlType type SQL du champs
	 */
	public SqlCompareValueCondition( Field p_oField, String p_sAlias, SqlType p_oSqlType) {
		this(p_oField, p_sAlias, p_oSqlType, OperatorCondition.EQUALS);
	}
	 ...
	 * @param p_operator a {@link com.adeuza.movalysfwk.mobile.mf4mjcommons.data.dao.query.conditions.OperatorCondition} object.
	 */
	public SqlCompareValueCondition( Field p_oField, String p_sAlias, SqlType p_oSqlType, OperatorCondition p_operator ) {
	...
	/**
	 * Constructeur avec champs, alias de la table du champs, type de la valeur et liaison avec l'ancienne clause et opérateur =
	 *
	 * @param p_oField champs
	 * @param p_sAlias alias de la table du champs
	 * @param p_oSqlType type SQL du champs
	 * @param p_oSqlClauseLink liaison avec l'ancienne clause
	 */
	public SqlCompareValueCondition( Field p_oField, String p_sAlias, SqlType p_oSqlType, SqlClauseLink p_oSqlClauseLink) {
		this(p_oField, p_sAlias, p_oSqlType, p_oSqlClauseLink, OperatorCondition.EQUALS);
	}
	 ...
	 * @param p_operator a {@link com.adeuza.movalysfwk.mobile.mf4mjcommons.data.dao.query.conditions.OperatorCondition} object.
	 */
	public SqlCompareValueCondition( Field p_oField, String p_sAlias, SqlType p_oSqlType, SqlClauseLink p_oSqlClauseLink, OperatorCondition p_operator ) {
		this.field = new SqlField(p_oField, p_sAlias);
		setLink(p_oSqlClauseLink);
		this.value = new SqlBindValue(null, p_oSqlType) ;
		this.operator = p_operator;
	 ...
	 * @param p_oSqlType type SQL du champs
	 */
	public SqlCompareValueCondition( Field p_oField, String p_sAlias, Object p_oValue, SqlType p_oSqlType) {
		this(p_oField, p_sAlias, p_oValue, p_oSqlType, OperatorCondition.EQUALS);
	}
	 ...
	 * @param p_operator a {@link com.adeuza.movalysfwk.mobile.mf4mjcommons.data.dao.query.conditions.OperatorCondition} object.
	 */
	public SqlCompareValueCondition( Field p_oField, String p_sAlias, Object p_oValue, SqlType p_oSqlType, OperatorCondition p_operator ) {
		this.field = new SqlField(p_oField, p_sAlias);
		this.value = new SqlBindValue(p_oValue, p_oSqlType) ;
		this.operator = p_operator;
	}
	...
	/**
	 * Constructeur avec champs, alias de la table du champs, valeur pour l'égalité, type de la valeur et liaison avec l'ancienne clause et opérateur =
	 *
	 * @param p_oField champs
	 * @param p_sAlias alias de la table du champs
	 * @param p_oValue valeur pour l'égalité
	 ...
	 * @param p_oSqlClauseLink liaison avec l'ancienne clause
	 */
	public SqlCompareValueCondition(
			Field p_oField, String p_sAlias, Object p_oValue, SqlType p_oSqlType, SqlClauseLink p_oSqlClauseLink) {
		this(p_oField, p_sAlias, p_oValue, p_oSqlType, p_oSqlClauseLink, OperatorCondition.EQUALS);
	}
	 ...
	 */
	public SqlCompareValueCondition(
			Field p_oField, String p_sAlias, Object p_oValue, SqlType p_oSqlType, SqlClauseLink p_oSqlClauseLink, OperatorCondition p_operator) {
		this.field = new SqlField(p_oField, p_sAlias);
		setLink(p_oSqlClauseLink);
		this.value = new SqlBindValue(p_oValue, p_oSqlType) ;
		this.operator = p_operator;
	...
	/**
	 * Constructeur avec champs, valeur bindée et liaison avec l'ancienne clause et opérateur =
	 *
	 * @param p_oField Field
	 * @param p_oValue Valeur bindée pour l'égalité
	 * @param p_oSqlClauseLink liaison avec l'ancienne clause
	 */
	public SqlCompareValueCondition( SqlField p_oField, SqlBindValue p_oValue, SqlClauseLink p_oSqlClauseLink) {
		this(p_oField, p_oValue, p_oSqlClauseLink, OperatorCondition.EQUALS);
	}
	 ...
	 * @param p_operator a {@link com.adeuza.movalysfwk.mobile.mf4mjcommons.data.dao.query.conditions.OperatorCondition} object.
	 */
	public SqlCompareValueCondition( SqlField p_oField, SqlBindValue p_oValue, SqlClauseLink p_oSqlClauseLink, OperatorCondition p_operator ) {
		this.field = p_oField;
		setLink(p_oSqlClauseLink);
		this.value = p_oValue ;
		this.operator = p_operator;
	...
	public AbstractSqlCondition clone() {
		return new SqlCompareValueCondition(this.field, this.value, getLink(), this.operator);
	}
