...
public class MParametersDaoImpl extends AbstractMParametersDaoImpl implements MParametersDao {
	...
	/** {@inheritDoc} */
	@Override
	public void deleteMparametersByName(MContext p_oContext, Field p_oField, @SqlType int p_oType, String p_sValue) throws DaoException {
	...
	/** {@inheritDoc} */
	@Override
	public List<MParameters> getListMParametersByField(MContext p_oContext, Field p_oField, @SqlType int p_iType, Object p_oValue, CascadeSet p_oCascadeSet)
			throws DaoException {
		
		DaoQuery oQuery = this.getSelectDaoQuery();
		oQuery.getSqlQuery().addEqualsConditionToWhere(p_oField.name(), p_oValue, p_iType);
