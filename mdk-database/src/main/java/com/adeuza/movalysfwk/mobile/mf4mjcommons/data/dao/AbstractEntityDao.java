...
//	protected DaoAccessHelper daoHelper;
	 ...
	 */
	protected abstract FieldType[] getPKFields();
	...
	protected abstract T valueObject(ResultSetReader p_oResultSetReader, DaoQuery p_oDaoQuery, DaoSession p_oDaoSession, CascadeSet p_oCascadeSet,
			CascadeOptim p_oCascadeOptim, MContext p_oContext) throws DaoException, IOException;
	 ...
	 */
	protected abstract T valueObject(ResultSetReader p_oResultSetReader, DaoQuery p_oDaoQuery, DaoSession p_oDaoSession, CascadeSet p_oCascadeSet,
			MContext p_oContext) throws DaoException, DaoException, IOException;
	 ...
	 *             erreur SQL
	 */
	protected abstract void bindInsert(T p_oEntity, MDKSQLiteStatement p_oPreparedStatement, MContext p_oContext) throws DaoException;
	 ...
	 *             erreur SQL
	 */
	protected abstract void bindUpdate(T p_oEntity, MDKSQLiteStatement p_oPreparedStatement, MContext p_oContext) throws DaoException;
