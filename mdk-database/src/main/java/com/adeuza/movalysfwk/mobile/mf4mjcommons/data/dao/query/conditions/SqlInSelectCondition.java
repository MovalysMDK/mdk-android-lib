...
public class SqlInSelectCondition extends AbstractSqlInCondition implements Cloneable {
	 ...
	 */
	public SqlInSelectCondition(String p_sFieldName, String p_sAlias, SqlType p_oSqlType, SqlQuery p_oSqlQuery ) {
		this.setField(p_sFieldName, p_sAlias, p_oSqlType);
	 ...
	 * @param p_oSqlQuery requête ramenant les valeurs du IN
	 */
	public SqlInSelectCondition(Field p_oField, String p_sAlias, SqlType p_oSqlType, SqlQuery p_oSqlQuery ) {
		this.setField(p_oField, p_sAlias, p_oSqlType);
		this.sqlQuery = p_oSqlQuery;
	}
