...
public class SqlLikeCondition extends AbstractSqlCondition implements Cloneable {
	 ...
	 * @param p_sValue a {@link java.lang.String} object.
	 * @param p_iValueSqlType a {@link com.adeuza.movalysfwk.mobile.mf4mjcommons.data.dao.SqlType} object.
	 */
	public SqlLikeCondition(Field p_oField, String p_sAlias, String p_sValue, @SqlType int p_iValueSqlType) {
		this.field = new SqlField(p_oField, p_sAlias);
		this.value = new SqlBindValue(SqlLikeCondition.wildcards(p_sValue), p_iValueSqlType);
	}
	 ...
	 * @param p_iValueSqlType a {@link com.adeuza.movalysfwk.mobile.mf4mjcommons.data.dao.SqlType} object.
	 */
	public SqlLikeCondition(String p_sFieldName, String p_sAlias, String p_sValue, @SqlType int p_iValueSqlType) {
	 ...
	 * @param p_iValueSqlType a {@link com.adeuza.movalysfwk.mobile.mf4mjcommons.data.dao.SqlType} object.
	 */
	public SqlLikeCondition(String p_sFieldName, String p_sValue, @SqlType int p_iValueSqlType) {
