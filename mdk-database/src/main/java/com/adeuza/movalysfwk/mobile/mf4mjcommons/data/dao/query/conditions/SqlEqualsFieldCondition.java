...
public class SqlEqualsFieldCondition extends AbstractSqlCondition implements Cloneable {
	 ...
	 * @param p_sFieldName2 nom du champs2
	 * @param p_sAlias2 alias de la table du champs 2
	 * @param p_oClauseLink a {@link com.adeuza.movalysfwk.mobile.mf4mjcommons.data.dao.query.SqlClauseLink} object.
	 */
	public SqlEqualsFieldCondition( String p_sFieldName1, String p_sAlias1, String p_sFieldName2, String p_sAlias2, SqlClauseLink p_oClauseLink ) {
		this.field1 = new SqlField(p_sFieldName1, p_sAlias1);
		this.field2 = new SqlField(p_sFieldName2, p_sAlias2);
		this.setLink(p_oClauseLink);
	}
	 ...
	 */
	public SqlEqualsFieldCondition( SqlField p_oField1, SqlField p_oField2, SqlClauseLink p_oSqlClauseLink ) {
		this.field1 = p_oField1;
		this.field2 = p_oField2;
	...
	public AbstractSqlCondition clone() {
		return new SqlEqualsFieldCondition(this.field1, this.field2, getLink());
	}
