...
public abstract class AbstractSqlInCondition extends AbstractSqlCondition {
	 ...
	 */
	private List<SqlInField> listFields = new ArrayList<SqlInField>();
	 ...
	 */
	public void setField( String p_sFieldName, String p_sAlias, SqlType p_oSqlType ) {
		this.listFields.clear();
		this.listFields.add( new SqlInField(p_sFieldName, p_sAlias, p_oSqlType));
	}
	 ...
	 * @param p_oSqlType type du champs
	 */
	public void setField( Field p_oField, String p_sAlias, SqlType p_oSqlType ) {
		listFields.clear();
		this.listFields.add( new SqlInField(p_oField.name(), p_sAlias, p_oSqlType));
	}
	 ...
	 */
	public void setFields( PairValue<Field, SqlType>[] p_listFields, String p_sAliasName ) {
		this.listFields.clear();
		for( PairValue<Field, SqlType> oPairValue : p_listFields ) {
			this.listFields.add( new SqlInField(oPairValue.getKey(), p_sAliasName, oPairValue.getValue()));
		}
	}
