...
public class SqlInField implements Cloneable {
	 ...
	 */
	public SqlInField( String p_sFieldName, String p_sAlias, @SqlType int p_iSqlType ) {
	 ...
	 * @param p_iSqlType type du champs
	 */
	public SqlInField( Field p_oField, String p_sAlias, @SqlType int p_iSqlType ) {
	 ...
	 * @param p_iSqlType type du champs
	 */
	public SqlInField( String p_sFieldName, @SqlType int p_iSqlType ) {
		this.fieldName = p_sFieldName ;
		this.sqlType = p_iSqlType ;
	}
