...
public class SqlGenericCondition extends AbstractSqlCondition implements Cloneable {
	 ...
	 */
	private List<SqlBindValue> values = new ArrayList<SqlBindValue>();
	...
	/**
	 * Constructeur avec le SQL, la clause de liaison et les valeurs bindées
	 *
	 * @param p_sSql SQL de la condition
	 * @param p_oSqlClauseLink liaison avec la condition précédente
	 * @param p_oValue liste des valeurs bindées
	 */
	public SqlGenericCondition( String p_sSql, SqlClauseLink p_oSqlClauseLink, SqlBindValue...p_oValue ) {
		this.sqlText = p_sSql ;
	...
	public AbstractSqlCondition clone() {
		return new SqlGenericCondition(this.sqlText, getLink());
	}
