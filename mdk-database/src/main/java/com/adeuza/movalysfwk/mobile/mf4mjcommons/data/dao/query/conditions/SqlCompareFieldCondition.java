...
public class SqlCompareFieldCondition extends AbstractSqlCondition implements Cloneable {
	 ...
	 * @param p_oField1 champs1
	 * @param p_oField2 champs2
	 * @param p_sOperator Opérateur de calcul
	 */
	public SqlCompareFieldCondition( Field p_oField1, Field p_oField2, @OperatorCondition String p_sOperator) {
	 ...
	 * @param p_sOperator Opérateur de calcul
	 */
	public SqlCompareFieldCondition( SqlField p_oField1, SqlField p_oField2, @OperatorCondition String p_sOperator ) {
	 ...
	 * @param p_operator Opérateur de calcul
	 */
	public SqlCompareFieldCondition( Field p_sFieldName1, String p_sAlias1, Field p_sFieldName2, 
			String p_sAlias2, @OperatorCondition String p_sOperator ) {
		this.field1 = new SqlField(p_sFieldName1, p_sAlias1);
		this.field2 = new SqlField(p_sFieldName2, p_sAlias2);
		this.operator = p_sOperator;
	}
	...
	public AbstractSqlCondition clone() {
		return new SqlCompareFieldCondition(this.field1, this.field2, this.operator);
	}
