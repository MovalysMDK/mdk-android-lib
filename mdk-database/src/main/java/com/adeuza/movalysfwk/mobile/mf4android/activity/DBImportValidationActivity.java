...
public class DBImportValidationActivity extends AbstractMMActivity implements OnClickListener {
	...
	protected void onCreate(Bundle p_oSavedInstanceState) {
		...
		passfield=(EditText) this.findViewById(this.getAndroidApplication().getAndroidIdByRKey(AndroidApplicationR.dialog_confirmPasswordForImportDatabase_content_edit));
		okBtn=(Button) this.findViewById(this.getAndroidApplication().getAndroidIdByRKey(AndroidApplicationR.dialog_confirmPasswordForImportDatabase_ok_button));
		okBtn.setOnClickListener(this);
		koBtn=(Button) this.findViewById(this.getAndroidApplication().getAndroidIdByRKey(AndroidApplicationR.dialog_confirmPasswordForImportDatabase_ko_button));
