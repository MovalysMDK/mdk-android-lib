...
public class SqlQuery implements Cloneable {
	 ...
	 */
	public void addEqualsConditionToWhere( Field p_oField, String p_sAlias, Object p_oObjectValue, SqlType p_oValueSqlType ) {
		this.sqlWhere.addSqlCondition(
			new SqlEqualsValueCondition( new SqlField(p_oField,p_sAlias), new SqlBindValue(p_oObjectValue, p_oValueSqlType)));
	}
	 ...
	 * @param p_oValueSqlType type du champs
	 */
	public void addEqualsConditionToWhere( String p_sFieldName, String p_sAlias, Object p_oObjectValue, SqlType p_oValueSqlType ) {
		this.sqlWhere.addSqlCondition(
			new SqlEqualsValueCondition( new SqlField(p_sFieldName,p_sAlias), new SqlBindValue(p_oObjectValue, p_oValueSqlType)));
	}
	 ...
	 * @param p_oValueSqlType type du champs
	 */
	public void addEqualsConditionToWhere( String p_sFieldName, Object p_oObjectValue, SqlType p_oValueSqlType ) {
		this.sqlWhere.addSqlCondition(
			new SqlEqualsValueCondition( new SqlField(p_sFieldName), new SqlBindValue(p_oObjectValue, p_oValueSqlType)));
	}
	 ...
	 * @param p_oValueSqlType type du champs
	 */
	public void addLikeConditionToWhere( Field p_oField, String p_sAlias, Object p_oObjectValue, SqlType p_oValueSqlType ) {
		this.sqlWhere.addSqlCondition(
			new SqlLikeCondition( new SqlField(p_oField,p_sAlias), new SqlBindValue(p_oObjectValue, p_oValueSqlType)));
	}
	 ...
	 * @param p_oValueSqlType type du champs
	 */
	public void addLikeConditionToWhere( Field p_oField, String p_sAlias, String p_sStringValue, SqlType p_oValueSqlType ) {
		this.sqlWhere.addSqlCondition(
			new SqlLikeCondition( p_oField, p_sAlias, p_sStringValue, p_oValueSqlType));
	}
	 ...
	 * @param p_oValueSqlType type du champs
	 */
	public void addLikeConditionToWhere( String p_sFieldName, Object p_oObjectValue, SqlType p_oValueSqlType ) {
		this.sqlWhere.addSqlCondition(
			new SqlLikeCondition( new SqlField(p_sFieldName), new SqlBindValue(p_oObjectValue, p_oValueSqlType)));
	}
	 ...
	 * @param p_oValueSqlType type du champs
	 */
	public void addLikeConditionToWhere( String p_sFieldName, String p_sStringValue, SqlType p_oValueSqlType ) {
	 ...
	 * @param p_oValueSqlType type du champs
	 */
	public void addLikeConditionToWhere( String p_sFieldName, String p_sAlias, Object p_oObjectValue, SqlType p_oValueSqlType ) {
		this.sqlWhere.addSqlCondition(
			new SqlLikeCondition( new SqlField(p_sFieldName,p_sAlias), new SqlBindValue(p_oObjectValue, p_oValueSqlType)));
	}
	 ...
	 * @param p_oValueSqlType type du champs
	 */
	public void addLikeConditionToWhere( String p_sFieldName, String p_sAlias, String p_sStringValue, SqlType p_oValueSqlType ) {
		this.sqlWhere.addSqlCondition(new SqlLikeCondition(p_sFieldName, p_sAlias, p_sStringValue, p_oValueSqlType));
	}
	 ...
	 */
	public void addInValueConditionToWhere( Field p_oField, String p_sAlias, SqlType p_oSqlType, List<?> p_listInValues ) {
		this.sqlWhere.addSqlCondition(new SqlInValueCondition( p_oField, p_sAlias, p_oSqlType, p_listInValues ));
	}
