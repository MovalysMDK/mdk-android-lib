...
public class SqlNotInValueCondition extends SqlInValueCondition {
	 ...
	 */
	public SqlNotInValueCondition(PairValue<Field, SqlType>[] p_listFields, String p_sAlias, List<?> p_listValues){
	 ...
	 * @param p_listValues liste des valeurs
	 */
	public SqlNotInValueCondition(PairValue<Field, SqlType>[] p_listFields, List<?> p_listValues){
