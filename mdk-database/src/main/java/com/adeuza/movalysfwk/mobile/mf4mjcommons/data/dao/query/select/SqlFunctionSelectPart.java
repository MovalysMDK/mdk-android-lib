...
public class SqlFunctionSelectPart extends AbstractSqlSelectPart implements Cloneable {
	 ...
	 * Sql Function
	 */
	private @SqlFunction String sqlFunction ;
	 ...
	 * @param p_sSqlFunction a {@link com.adeuza.movalysfwk.mobile.mf4mjcommons.data.dao.query.SqlFunction} object.
	 */
	public SqlFunctionSelectPart( @SqlFunction String p_sSqlFunction, Field p_oField, String p_sTablePrefix ) {
		this.sqlField = new SqlField( p_oField, p_sTablePrefix );
		this.sqlFunction = p_sSqlFunction ;
	}
	 ...
	 * @param p_sSqlFunction a {@link com.adeuza.movalysfwk.mobile.mf4mjcommons.data.dao.query.SqlFunction} object.
	 */
	protected SqlFunctionSelectPart( @SqlFunction String p_sSqlFunction, String p_sField, String p_sTablePrefix ) {
	...
	public void toSql(StringBuilder p_oStringBuilder, ToSqlContext p_oToSqlContext ) {
		p_oStringBuilder.append(this.sqlFunction);
