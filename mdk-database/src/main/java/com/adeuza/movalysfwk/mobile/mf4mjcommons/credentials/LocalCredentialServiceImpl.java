...
public class LocalCredentialServiceImpl implements LocalCredentialService {
	...
	public void storeCredentials(String p_sLogin, long p_lResourceId, MContext p_oContext)
		...
		try {
			...
			oParameterDao.deleteMparametersByName(p_oContext, MParametersField.NAME, SqlType.VARCHAR,
	...
	public void deleteLocalCredentials( MContext p_oContext ) throws CredentialException {
		try {
			...
			oDataHelper.deleteMparametersByName(p_oContext, MParametersField.NAME, SqlType.VARCHAR, PREVIOUS_LOGIN_PARAMETER);
			oDataHelper.deleteMparametersByName(p_oContext, MParametersField.NAME, SqlType.VARCHAR, PREVIOUS_RESOURCE_PARAMETER);
			oDataHelper.deleteMparametersByName(p_oContext, MParametersField.NAME, SqlType.VARCHAR, PREVIOUS_SYNC_DATE_PARAMETER);
