...
public class SqlNullCondition extends AbstractSqlCondition implements Cloneable {
	...
	/**
	 * Constructeur avec champ, null, type de liaison
	 *
	 * @param p_oField a {@link com.adeuza.movalysfwk.mobile.mf4mjcommons.data.dao.Field} object.
	 * @param p_oSqlClauseLink a {@link com.adeuza.movalysfwk.mobile.mf4mjcommons.data.dao.query.SqlClauseLink} object.
	 */
	public SqlNullCondition(Field p_oField, SqlClauseLink p_oSqlClauseLink) {
		this(p_oField, true, p_oSqlClauseLink);
	}
	 ...
	 * @param p_oSqlClauseLink a {@link com.adeuza.movalysfwk.mobile.mf4mjcommons.data.dao.query.SqlClauseLink} object.
	 */
	public SqlNullCondition(SqlField p_oField, SqlClauseLink p_oSqlClauseLink) {
		this(p_oField, true, p_oSqlClauseLink);
	}
	...
	/**
	 * Constructeur avec champ, alias, null, type de liaison
	 *
	 * @param p_oField a {@link com.adeuza.movalysfwk.mobile.mf4mjcommons.data.dao.Field} object.
	 * @param p_sAlias a {@link java.lang.String} object.
	 * @param p_oSqlClauseLink a {@link com.adeuza.movalysfwk.mobile.mf4mjcommons.data.dao.query.SqlClauseLink} object.
	 */
	public SqlNullCondition(Field p_oField, String p_sAlias, SqlClauseLink p_oSqlClauseLink) {
		this(p_oField, p_sAlias, true, p_oSqlClauseLink);
	}
	...
	/**
	 * Constructeur avec nom de champ, null, type de liaison
	 *
	 * @param p_sFieldName a {@link java.lang.String} object.
	 * @param p_oSqlClauseLink a {@link com.adeuza.movalysfwk.mobile.mf4mjcommons.data.dao.query.SqlClauseLink} object.
	 */
	public SqlNullCondition(String p_sFieldName, SqlClauseLink p_oSqlClauseLink) {
		this(p_sFieldName, true, p_oSqlClauseLink);
	}
	...
	/**
	 * Constructeur avec nom de champ, alias, null, type de liaison
	 *
	 * @param p_sFieldName a {@link java.lang.String} object.
	 * @param p_sAlias a {@link java.lang.String} object.
	 * @param p_oSqlClauseLink a {@link com.adeuza.movalysfwk.mobile.mf4mjcommons.data.dao.query.SqlClauseLink} object.
	 */
	public SqlNullCondition(String p_sFieldName, String p_sAlias, SqlClauseLink p_oSqlClauseLink) {
		this(p_sFieldName, p_sAlias, true, p_oSqlClauseLink);
	}
	...
	/**
	 * Constructeur avec champ, alias, indicateur de nullité, type de liaison
	 *
	 * @param p_oField a {@link com.adeuza.movalysfwk.mobile.mf4mjcommons.data.dao.Field} object.
	 * @param p_bIsNull a boolean.
	 * @param p_sAlias a {@link java.lang.String} object.
	 * @param p_oSqlClauseLink a {@link com.adeuza.movalysfwk.mobile.mf4mjcommons.data.dao.query.SqlClauseLink} object.
	 */
	public SqlNullCondition(Field p_oField, String p_sAlias, boolean p_bIsNull, SqlClauseLink p_oSqlClauseLink) {
		this.field = new SqlField(p_oField, p_sAlias);
		this.isNull = p_bIsNull;
	...
	/**
	 * Constructeur avec champ, indicateur de nullité, type de liaison
	 *
	 * @param p_oField a {@link com.adeuza.movalysfwk.mobile.mf4mjcommons.data.dao.Field} object.
	 * @param p_bIsNull a boolean.
	 * @param p_oSqlClauseLink a {@link com.adeuza.movalysfwk.mobile.mf4mjcommons.data.dao.query.SqlClauseLink} object.
	 */
	public SqlNullCondition(Field p_oField, boolean p_bIsNull, SqlClauseLink p_oSqlClauseLink) {
		this.field = new SqlField(p_oField);
		this.isNull = p_bIsNull;
		this.setLink(p_oSqlClauseLink);
	}
	 ...
	 * @param p_oSqlClauseLink a {@link com.adeuza.movalysfwk.mobile.mf4mjcommons.data.dao.query.SqlClauseLink} object.
	 */
	public SqlNullCondition(SqlField p_oField, boolean p_bIsNull, SqlClauseLink p_oSqlClauseLink) {
		this.field = p_oField;
		this.isNull = p_bIsNull;
		this.setLink(p_oSqlClauseLink);
	}
	...
	/**
	 * Constructeur avec nom de champ, indicateur de nullité, type de liaison
	 *
	 * @param p_bIsNull a boolean.
	 * @param p_sFieldName a {@link java.lang.String} object.
	 * @param p_oSqlClauseLink a {@link com.adeuza.movalysfwk.mobile.mf4mjcommons.data.dao.query.SqlClauseLink} object.
	 */
	public SqlNullCondition(String p_sFieldName, boolean p_bIsNull, SqlClauseLink p_oSqlClauseLink) {
		this.field = new SqlField(p_sFieldName);
		this.isNull = p_bIsNull;
		this.setLink(p_oSqlClauseLink);
	}
	...
	/**
	 * Constructeur avec nom de champ, alias, indicateur de nullité, type de liaison
	 *
	 * @param p_bIsNull a boolean.
	 * @param p_sFieldName a {@link java.lang.String} object.
	 * @param p_sAlias a {@link java.lang.String} object.
	 * @param p_oSqlClauseLink a {@link com.adeuza.movalysfwk.mobile.mf4mjcommons.data.dao.query.SqlClauseLink} object.
	 */
	public SqlNullCondition(String p_sFieldName, String p_sAlias, boolean p_bIsNull, SqlClauseLink p_oSqlClauseLink) {
		this.field = new SqlField(p_sFieldName, p_sAlias);
		this.isNull = p_bIsNull;
		this.setLink(p_oSqlClauseLink);
	}
	...
	public AbstractSqlCondition clone() {
		return new SqlNullCondition(field, isNull, getLink());
	}
