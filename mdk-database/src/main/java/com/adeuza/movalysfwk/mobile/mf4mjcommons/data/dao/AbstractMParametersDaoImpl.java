...
public abstract class AbstractMParametersDaoImpl extends AbstractEntityDao<MParameters> implements Initializable {
	...
	protected void saveMParameters(MParameters p_oMParameters, CascadeSet p_oCascadeSet, MContext p_oContext) throws DaoException {
		if (!p_oContext.getMessages().hasErrors()) {
			...
			MDKSQLiteStatement oStatement = oConnection.compileStatement(sSql);
			try {
	...
	protected MParameters valueObject(ResultSetReader p_oResultSetReader, DaoQuery p_oDaoQuery, DaoSession p_oDaoSession, CascadeSet p_oCascadeSet,
			MContext p_oContext) throws DaoException, IOException {
	 ...
	 */
	@Override
	protected void bindInsert(MParameters p_oMParameters, MDKSQLiteStatement p_oPreparedStatement, MContext p_oContext)
			throws DaoException {
		p_oPreparedStatement.bindLong(p_oMParameters.getId());
		p_oPreparedStatement.bindString(p_oMParameters.getName());
		p_oPreparedStatement.bindString(p_oMParameters.getValue());
	 ...
	 */
	@Override
	protected void bindUpdate(MParameters p_oMParameters, MDKSQLiteStatement p_oPreparedStatement, MContext p_oContext)
			throws DaoException {
		p_oPreparedStatement.bindLong(p_oMParameters.getId());
		p_oPreparedStatement.bindString(p_oMParameters.getName());
		p_oPreparedStatement.bindString(p_oMParameters.getValue());
