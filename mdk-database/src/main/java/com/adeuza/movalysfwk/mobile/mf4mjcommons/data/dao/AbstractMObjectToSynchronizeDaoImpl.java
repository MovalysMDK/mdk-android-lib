...
public abstract class AbstractMObjectToSynchronizeDaoImpl extends AbstractEntityDao<MObjectToSynchronize> implements Initializable {
	...
	protected MObjectToSynchronize valueObject(ResultSetReader p_oResultSetReader, DaoQuery p_oDaoQuery, DaoSession p_oDaoSession,
			CascadeSet p_oCascadeSet, MContext p_oContext) throws SQLException, DaoException, IOException {
	...
	@Override
	protected MObjectToSynchronize valueObject(ResultSetReader p_oResultSetReader, DaoQuery p_oDaoQuery, DaoSession p_oDaoSession,
			CascadeSet p_oCascadeSet, CascadeOptim p_oCascadeOptim, MContext p_oContext) throws SQLException, IOException {
	 ...
	 */
	@Override
	protected void bindInsert(MObjectToSynchronize p_oMObjectToSynchronize, PreparedStatement p_oPreparedStatement, MContext p_oContext)
			throws DaoException, SQLException {

		StatementBinder oStatementBinder = new StatementBinder(p_oPreparedStatement);
		oStatementBinder.bindLong(p_oMObjectToSynchronize.getId());
		oStatementBinder.bindLong(p_oMObjectToSynchronize.getObjectId());
		oStatementBinder.bindString(p_oMObjectToSynchronize.getObjectName());
	}
	 ...
	 */
	@Override
	protected void bindUpdate(MObjectToSynchronize p_oMObjectToSynchronize, PreparedStatement p_oPreparedStatement, MContext p_oContext)
			throws DaoException, SQLException {
