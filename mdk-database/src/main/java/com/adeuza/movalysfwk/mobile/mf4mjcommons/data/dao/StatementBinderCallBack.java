...
public interface StatementBinderCallBack {
	 ...
	 * @throws DaoException déclenchée si l'exécution du bind déclencenche une exception SQL
	 ...
	 */
	public void doBind( MDKSQLiteStatement p_oStatement ) throws DaoException ; 
