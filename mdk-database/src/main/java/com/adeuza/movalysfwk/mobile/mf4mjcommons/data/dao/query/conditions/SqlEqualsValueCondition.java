...
public class SqlEqualsValueCondition extends AbstractSqlCondition implements Cloneable {
	 ...
	 */
	public SqlEqualsValueCondition( SqlField p_oField, @SqlType int p_iSqlType ) {
		this.field = p_oField;
	 ...
	 * @param p_iSqlType type de la valeur
	 */
	public SqlEqualsValueCondition( String p_sFieldName, @SqlType int p_iSqlType ) {
	 ...
	 * @param p_iSqlType type de la valeur
	 */
	public SqlEqualsValueCondition( String p_sFieldName, Object p_oValue, @SqlType int p_iSqlType ) {
		this.field = new SqlField(p_sFieldName);
	 ...
	 * @param p_oValue valeur
	 */
	public SqlEqualsValueCondition( String p_sFieldName, String p_sAlias, Object p_oValue, @SqlType int p_iSqlType ) {
	 ...
	 * @param p_iSqlType type SQL du champs
	 */
	public SqlEqualsValueCondition( String p_sFieldName, String p_sAlias, @SqlType int p_iSqlType ) {
		this.field = new SqlField(p_sFieldName, p_sAlias);
		this.value = new SqlBindValue(null, p_iSqlType) ;
	}
	 ...
	 * @param p_iSqlType type SQL du champs
	 */
	public SqlEqualsValueCondition( Field p_oField, String p_sAlias, @SqlType int p_iSqlType ) {
	 ...
	 * @param p_iSqlType type SQL du champs
	 */
	public SqlEqualsValueCondition( Field p_oField, String p_sAlias, Object p_oValue, @SqlType int p_iSqlType ) {
		this.field = new SqlField(p_oField, p_sAlias);
		this.value = new SqlBindValue(p_oValue, p_iSqlType) ;
	}
	 ...
	 * @param p_iSqlType type SQL du champs
	 */
	public SqlEqualsValueCondition( Field p_oField, Object p_oValue, @SqlType int p_iSqlType ) {
		this.field = new SqlField(p_oField);
		this.value = new SqlBindValue(p_oValue, p_iSqlType) ;
	}
	...
	public AbstractSqlCondition clone() {
		return new SqlEqualsValueCondition(this.field, this.value);
	}
