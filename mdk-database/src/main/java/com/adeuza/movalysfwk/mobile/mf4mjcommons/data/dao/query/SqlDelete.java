...
public class SqlDelete implements Cloneable {
	 ...
	 */
	public SqlEqualsValueCondition addEqualsConditionToWhere( Field p_oField, Object p_oObjectValue, SqlType p_oValueSqlType ) {
		SqlEqualsValueCondition r_oSqlEqualsValueCondition =
			new SqlEqualsValueCondition( new SqlField(p_oField), new SqlBindValue(p_oObjectValue, p_oValueSqlType));
	...
	public SqlEqualsValueCondition addEqualsConditionToWhere( Field p_oField, SqlType p_oValueSqlType ) {
		SqlEqualsValueCondition r_oSqlEqualsValueCondition =
			new SqlEqualsValueCondition( new SqlField(p_oField), new SqlBindValue(null, p_oValueSqlType));
		this.sqlWhere.addSqlCondition(r_oSqlEqualsValueCondition);
		return r_oSqlEqualsValueCondition ;
	}
	 ...
	 * @return retourne la condition ajoutée
	 */
	public SqlEqualsValueCondition addEqualsConditionToWhere( String p_sFieldName, Object p_oObjectValue, SqlType p_oValueSqlType ) {
		SqlEqualsValueCondition r_oSqlEqualsValueCondition =
	...
	public SqlEqualsValueCondition addEqualsConditionToWhere( String p_sFieldName, SqlType p_oValueSqlType ) {
		SqlEqualsValueCondition r_oSqlEqualsValueCondition =
			new SqlEqualsValueCondition( new SqlField(p_sFieldName), new SqlBindValue(null, p_oValueSqlType));
		this.sqlWhere.addSqlCondition(r_oSqlEqualsValueCondition);
		return r_oSqlEqualsValueCondition ;
	}
	 ...
	 * @return retourne la condition ajoutée
	 */
	public SqlLikeCondition addLikeConditionToWhere( String p_sFieldName, Object p_oObjectValue, SqlType p_oValueSqlType ) {
		SqlLikeCondition r_oSqlLikeCondition = new SqlLikeCondition( new SqlField(p_sFieldName), new SqlBindValue(p_oObjectValue, p_oValueSqlType));
