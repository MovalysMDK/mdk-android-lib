...
public interface MParametersDao extends EntityDao<MParameters> {
	 ...
	 */
	public static final FieldType[] PK_FIELDS = new FieldType[] { new FieldType(MParametersField.ID, SqlType.INTEGER) };
	 ...
	 * @param p_iType le type du champ
	 * @param p_sValue valeur du champ
	 * @throws com.adeuza.movalysfwk.mobile.mf4mjcommons.data.dao.DaoException déclenchée si une exception technique survient
	 */
	public void deleteMparametersByName(MContext p_oContext, Field p_oField, @SqlType int p_iType, String p_sValue) throws DaoException;
	 ...
	 * @throws com.adeuza.movalysfwk.mobile.mf4mjcommons.data.dao.DaoException déclenchée si une exception technique survient
	 */
	public List<MParameters> getListMParametersByField(MContext p_oContext, Field p_oField, @SqlType int p_iType, Object p_oValue, CascadeSet p_oCascadeSet) throws DaoException;
