 ...
 * 
 */
public class MMScanEditText extends AbstractMMLinearLayout<String> implements MMComplexeComponent, TextWatcher, ComponentGetSetAndFilled<String>, ComponentEnable {
	...
	private static final int SCAN_CODE_ACTIVITY = getUniqueRequestCode();
	...
	private static int getUniqueRequestCode() {
		int hash = MMScanEditText.class.getSimpleName().hashCode();
		...
		return Math.abs(hash) & NumericConstants.HEXADECIMAL_MASK;
	}
	...
	private OnClickListener oScanButtonOnClickListener = new OnClickListener() {
		...
		public void onClick(View p_oArg0) {
			MMDialogFragment oDownloadBarCodeScanner = SCAN_COMMAND.initiateScanCommand(
					...
					SCAN_CODE_ACTIVITY, scanType, MMScanEditText.this);
