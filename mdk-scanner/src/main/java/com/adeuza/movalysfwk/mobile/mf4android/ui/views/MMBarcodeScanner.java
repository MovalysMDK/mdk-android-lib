...
public class MMBarcodeScanner extends CaptureActivity implements ConfigurableVisualComponent ,InstanceStatable, ComponentBindDestroy, ComponentGetSetAndFilled<String> {
