...
/**
 * <p>Annotation à utiliser pour déclarer une méthode "callback" de la fin en erreur d'une action. Ne fonctionne que sur un screen ou un fragment.</p>
 */
@Target(ElementType.METHOD)
@Retention(RetentionPolicy.RUNTIME)
public @interface ListenerOnActionFail {
