...
/**
 * Processes to execute in the {@link MDKFlipperAdapter} for the group view
 ...
 */
public class FlipperAdapterGroup<
	...
	public ViewModel getCurrentViewModel(
			...
			int... p_oPositions) {
		return p_oAdapter.getGroup(p_oPositions[0], p_oPositions[1]);
	}
	...
	public void doAfterInflateRow(MDKFlipperAdapter<ITEM, SUBITEM, SUBSUBITEM, SUBSUBITEMVM, SUBITEMVM, ITEMVM> p_oAdapter, LayoutInflater p_oLayoutInflater, View p_oCurrentRow, View p_oView) {
		if (p_oAdapter.getGroupLayout() != 0) {
			ViewGroup oContentView = (ViewGroup) p_oLayoutInflater.inflate(p_oAdapter.getGroupLayout(), null);
	...
	public void doAfterRestoreRow(MDKFlipperAdapter<ITEM, SUBITEM, SUBSUBITEM, SUBSUBITEMVM, SUBITEMVM, ITEMVM> p_oAdapter, View p_oCurrentRow, MasterVisualComponent p_oCompositeComponent) {
		...
		if (p_oAdapter.getGroupLayout() != 0) {
			p_oCurrentRow = p_oCurrentRow.findViewById(p_oAdapter.getGroupLayout());
		}
	}
	...
	public ConfigurableListViewHolder getViewHolder(
		...
		return p_oAdapter.createViewHolderGroupItem(p_oView, p_bExpanded);
	}
	...
	public void postBind(
			...
			int... p_oPositions) {
		p_oAdapter.postBindGroupView(p_oCurrentRow, (SUBITEMVM) p_oCurrentVM, p_oPositions[0], b_isExpanded);
	}
}
