...
public class MDKRichSeekBarWrapper extends AbstractComponentWrapper<View>
        implements AndroidComponentWrapper, ConfigurableVisualComponent,
        VisualComponentDelegate<Integer>, ChangeListener {
    ...
    public Integer configurationGetValue() {
        ...
        if (v != null) {
            if (v instanceof HasSeekBar) {
                return ((HasSeekBar)v).getSeekBarValue();
            }
        }
        ...
        if (v != null) {
            if (v instanceof HasSeekBar) {
            	...
            	if (p_oObjectToSet != null){
            		oProgress = p_oObjectToSet.intValue();
            	}
