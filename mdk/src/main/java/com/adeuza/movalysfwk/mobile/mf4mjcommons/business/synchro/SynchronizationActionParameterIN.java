...
/**
 * <p>SynchronizationActionParameterIN class.</p>
 *
 */
public class SynchronizationActionParameterIN extends RedirectActionParameterImpl {
	
	/**
	 * 
	 */
	public boolean firstSynchro = false;
