...
public class DataloaderException extends Exception {
	 ...
	 * Constructor
	 *
	 * @param p_sMessage message
	 * @param p_oCause cause
	 */
	public DataloaderException(String p_sMessage, Throwable p_oCause) {
	 ...
	 * @param p_oCause cause
	 */
	public DataloaderException(Throwable p_oCause) {
		 super(p_oCause);
	 }
}
