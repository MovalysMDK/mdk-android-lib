 ...
 */
public class LongFormFieldValidatorImpl extends AbstractFormFieldValidator implements LongFormFieldValidator {
	/** {@inheritDoc} */
	@Override
	...
	public boolean validateMinValue(ConfigurableVisualComponent p_oComponent, BasicComponentConfiguration p_oConfiguration,
		...
		if (oMinValue != null
				...
				&& Long.parseLong(p_oComponent.getComponentDelegate().configurationGetValue().toString()) < Long.parseLong(oMinValue.toString())) {
	...
	public boolean validateMaxValue(ConfigurableVisualComponent p_oComponent, BasicComponentConfiguration p_oConfiguration,
		...
		if (oMaxValue != null
				&& p_oComponent.getComponentDelegate().configurationGetValue() != null
				&& Long.parseLong(p_oComponent.getComponentDelegate().configurationGetValue().toString()) > Long.parseLong(oMaxValue.toString())) {
	...
	/** {@inheritDoc} */
	@Override
	public Long getMinValue(BasicComponentConfiguration p_oConfiguration) {
		Object oMinValue = null;
		if (p_oConfiguration != null) {
			oMinValue = p_oConfiguration.getParameter(getMinValueParameterName());
			if (oMinValue == null && p_oConfiguration.getEntityFieldConfiguration() != null) {
		...
		if (oMinValue != null ) {
			return Long.parseLong(oMinValue.toString());
		}
		return null ;
	}
	/** {@inheritDoc} */
	@Override
	public Long getMaxValue(BasicComponentConfiguration p_oConfiguration) {
		...
		if (oMaxValue != null ) {
			return Long.parseLong(oMaxValue.toString());
		}
		return null ;
	}
	/**
