...
public class MDKRichMediaWrapper extends AbstractComponentWrapper<View>
        implements AndroidComponentWrapper, ConfigurableVisualComponent,
        VisualComponentDelegate<MPhotoVO>, ChangeListener {
    ...
    /**
     * The MPhotoVO component.
     */
    private MPhotoVO mPhotoVO;
    ...
    public MPhotoVO configurationGetValue() {
        View v = this.component.get();
        if (v != null) {
            if (v instanceof HasMedia) {
                if (this.mPhotoVO == null) {
                    this.mPhotoVO = new MPhotoVO();
                }
                if (((HasMedia) v).getMediaUri() != null) {
                    this.mPhotoVO.setUri(((HasMedia) v).getMediaUri().toString());
                } else {
                    this.mPhotoVO.setUri(null);
                }
                this.mPhotoVO.setSvg(((HasMedia) v).getModifiedPhotoSvg());
    ...
    public void configurationSetValue(MPhotoVO p_oObjectToSet) {
        ...
        if (v != null && p_oObjectToSet != null && v instanceof HasMedia) {
            Uri uri = null;
            if (p_oObjectToSet.getUri() != null) {
                uri = Uri.parse(p_oObjectToSet.getUri());
            }
            ((HasMedia) v).updateMedia(uri, p_oObjectToSet.getSvg());
        }
    ...
    public boolean isNullOrEmptyValue(MPhotoVO p_oObject) {
        return p_oObject == null || p_oObject.getUri() == null;
    }
    ...
    public boolean isFilled() {
        ...
        if (v != null) {
            if (v instanceof HasMedia) {
                return ((HasMedia) v).getMediaUri() != null;
            }
        }
        return false;
    }
    ...
    public void doOnPostAutoBind() {
        View v = this.component.get();
        if (v != null && v instanceof HasChangeListener) {
            ((HasChangeListener) v).registerChangeListener(this);
        }
    }
