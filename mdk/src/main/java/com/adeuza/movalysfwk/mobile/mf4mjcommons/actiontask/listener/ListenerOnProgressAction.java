...
/**
 * <p>Annotation à utiliser pour déclarer une méthode "callback" de la progression d'une action. Lorsqu'une action
 * publie un avancement la méthode "callback" est appelée. La méthode "callback" sera solicitée lorque l'action
 * passera par le ou les états indiqués. Ne fonctionne que sur un screen ou un fragment.</p>
 */
@Target(ElementType.METHOD)
@Retention(RetentionPolicy.RUNTIME)
public @interface ListenerOnProgressAction {
	...
	/**
	 * Indique à quels états d'avancement d'action la méthode "callback" est attachée
	 *
