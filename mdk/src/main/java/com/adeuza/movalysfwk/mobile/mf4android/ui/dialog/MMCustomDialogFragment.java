...
public class MMCustomDialogFragment extends MMDialogFragment{
	...
	public static MMCustomDialogFragment newInstance(Context p_oContext, /*int p_iTheme, */String p_sTitle, String p_sMessage, String p_sPositiveButtonText,
			...
			OnClickListener p_oPositiveButtonClickListener, 
			OnClickListener p_oNegativeButtonClickListener, 
			OnClickListener p_oCancelButtonClickListener,
...
//		oFragment.setStyle(STYLE_NORMAL, p_iTheme);		oFragment.m_oDismissListener = new WeakReference<OnDismissListener>(p_oDismissListener);
	...
	public void onDismiss(DialogInterface p_oDialog) {
		m_oContext = null;
		m_oApplication = null;
		m_oNegativeButtonClickListener = null;
		m_oPositiveButtonClickListener = null;
		m_oCancelButtonClickListener = null;
		m_uiContentView = null;
