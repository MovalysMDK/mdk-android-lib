 ...
 *
 */
public interface ExpandableViewModel<ITEM extends MIdentifiable,SUBITEM extends MIdentifiable,SUBITEMVM extends ItemViewModel<SUBITEM>> extends ItemViewModel<ITEM> {
