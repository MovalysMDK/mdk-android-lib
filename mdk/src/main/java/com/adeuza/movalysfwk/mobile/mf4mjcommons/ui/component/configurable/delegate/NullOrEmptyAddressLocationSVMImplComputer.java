...
public class NullOrEmptyAddressLocationSVMImplComputer implements
		NullOrEmptyComputer {

	@Override
	public <VALUE> boolean isNullOrEmpty(VALUE p_oObject) {
		return p_oObject == null || (((AddressLocationSVMImpl) p_oObject).getLatitude()==null || ((AddressLocationSVMImpl) p_oObject).getLongitude()==null);
	}
