 ...
 */
public class DoubleFormFieldValidatorImpl extends AbstractFormFieldValidator implements DoubleFormFieldValidator {
	/** {@inheritDoc} */
	@Override
	...
	public boolean validateMinValue(ConfigurableVisualComponent p_oComponent, BasicComponentConfiguration p_oConfiguration,
		...
		if (oMinValue != null
				...
				&& Double.parseDouble(p_oComponent.getComponentDelegate().configurationGetValue().toString()) < Double.parseDouble(oMinValue.toString())) {
	...
	public boolean validateMaxValue(ConfigurableVisualComponent p_oComponent, BasicComponentConfiguration p_oConfiguration,
		...
		if (oMaxValue != null
				&& p_oComponent.getComponentDelegate().configurationGetValue() != null
				&& Double.parseDouble(p_oComponent.getComponentDelegate().configurationGetValue().toString()) > Double.parseDouble(oMaxValue.toString())) {
	...
	public Double getMinValue(BasicComponentConfiguration p_oConfiguration){
		...
		if (oMinValue != null ) {
			return Double.parseDouble(oMinValue.toString());
		}
		return null ;
	}
	/** {@inheritDoc} */
	...
	public Double getMaxValue(BasicComponentConfiguration p_oConfiguration){
		...
		if (oMaxValue != null ) {
			return Double.parseDouble(oMaxValue.toString());
		}
		return null ;
	}
