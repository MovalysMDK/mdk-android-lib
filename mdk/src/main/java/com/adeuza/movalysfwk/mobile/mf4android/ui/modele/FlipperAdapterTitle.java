...
/**
 * Processes to execute in the {@link MDKFlipperAdapter} for the title view
...
public class FlipperAdapterTitle<
	...
	public void doAfterInflateRow(MDKFlipperAdapter<ITEM, SUBITEM, SUBSUBITEM, SUBSUBITEMVM, SUBITEMVM, ITEMVM> p_oAdapter, LayoutInflater p_oLayoutInflater, View p_oCurrentRow, View p_oView) {
		if (p_oAdapter.getTitleLayout() != 0) {
			ViewGroup oContentView = (ViewGroup) p_oLayoutInflater.inflate(p_oAdapter.getTitleLayout(), null);
	...
	public void doAfterRestoreRow(MDKFlipperAdapter<ITEM, SUBITEM, SUBSUBITEM, SUBSUBITEMVM, SUBITEMVM, ITEMVM> p_oAdapter, View p_oCurrentRow, MasterVisualComponent p_oCompositeComponent) {
		...
		if (p_oAdapter.getTitleLayout() != 0) {
			p_oCurrentRow = p_oCurrentRow.findViewById(p_oAdapter.getTitleLayout());
		}
	}
	...
	public ConfigurableListViewHolder getViewHolder(
		...
		return p_oAdapter.createViewHolderTitleItem(p_oView, p_bExpanded);
	}
	...
	public void postInflate(
		...
		p_oAdapter.postInflateTitleView(p_oCurrentRow, b_isExpanded);
	}
	...
	public void postBind(
			...
			int... p_oPositions) {
		p_oAdapter.postBindTitleView(p_oCurrentRow, (ITEMVM) p_oCurrentVM, p_oPositions[0], b_isExpanded);
	}
}
