...
public interface ApplicationMain {
	...
	/**
	 * Analyses settings to find any problems like mandatory setting not filled
	 */
	public void analyseSettings();
	
	/**
	 * This method is called when there is a problem in setting
	 */
