...
public abstract class AbstractBtPrintCommand extends AbstractMMActivity implements OnClickListener{
	...
	private TextView oUiReference;
	/** the message field in the dialog */
	private TextView oUiMessage;
	/** the error field in the dialog */
	private TextView oUiError;
	...
	protected void onCreate(Bundle p_oSavedInstanceState) {
		...
		oUiReference = (TextView) this.findViewById(this.oApplication.getAndroidIdByRKey(AndroidApplicationR.component_btprint__btprintDialog_reference__value));
		oUiMessage = (TextView) this.findViewById(this.oApplication.getAndroidIdByRKey(AndroidApplicationR.component_btprint__btprintDialog_message__value));
		oUiError = (TextView) this.findViewById(this.oApplication.getAndroidIdByRKey(AndroidApplicationR.component_btprint__btprintDialog_error__value));
