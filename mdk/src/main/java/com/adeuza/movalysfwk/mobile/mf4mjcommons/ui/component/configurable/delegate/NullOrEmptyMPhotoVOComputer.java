...
public class NullOrEmptyMPhotoVOComputer implements NullOrEmptyComputer {

	@Override
	public <VALUE> boolean isNullOrEmpty(VALUE p_oObject) {
		return p_oObject == null || (((MPhotoVO) p_oObject).getLocalUri() == null && ((MPhotoVO) p_oObject).getRemoteUri() == null);
	}
