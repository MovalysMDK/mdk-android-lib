...
/**
 * Describes a multi section fragment layout 
 */
@MMAlwaysEnable
public class MMMultiSectionFragmentLayout extends LinearLayout implements ConfigurableLayoutComponent {
	...
	/** aivDelegate */
	private AndroidConfigurableVisualComponentDelegate<NoneType> aivDelegate ;

	/**
	 * Constructs a new MMMultiSectionFragmentLayout
	 * 
