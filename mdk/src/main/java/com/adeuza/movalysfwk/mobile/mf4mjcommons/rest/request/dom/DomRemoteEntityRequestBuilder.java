...
/**
 * <p>DomRemoteEntityRequestBuilder interface.</p>
 *
 */
public interface DomRemoteEntityRequestBuilder<R extends RestRequest> {

	/**
	 * <p>buildRequest.</p>
	 *
	 * @param p_oRequest a R object.
	 ...
	 */
	public void buildRequest( R p_oRequest, MContext p_oContext ) throws SynchroException;
}
