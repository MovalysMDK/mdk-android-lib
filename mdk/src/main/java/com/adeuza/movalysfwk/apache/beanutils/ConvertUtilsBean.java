...
import com.adeuza.movalysfwk.apache.beanutils.converters.AbstractConverter;
import com.adeuza.movalysfwk.apache.beanutils.converters.ArrayConverter;
import com.adeuza.movalysfwk.apache.beanutils.converters.BooleanConverter;
import com.adeuza.movalysfwk.apache.beanutils.converters.ByteConverter;
import com.adeuza.movalysfwk.apache.beanutils.converters.CharacterConverter;
import com.adeuza.movalysfwk.apache.beanutils.converters.ClassConverter;
import com.adeuza.movalysfwk.apache.beanutils.converters.ConverterFacade;
import com.adeuza.movalysfwk.apache.beanutils.converters.DateConverter;
import com.adeuza.movalysfwk.apache.beanutils.converters.DoubleConverter;
import com.adeuza.movalysfwk.apache.beanutils.converters.FloatConverter;
import com.adeuza.movalysfwk.apache.beanutils.converters.IntegerConverter;
import com.adeuza.movalysfwk.apache.beanutils.converters.LongConverter;
import com.adeuza.movalysfwk.apache.beanutils.converters.ShortConverter;
import com.adeuza.movalysfwk.apache.beanutils.converters.SqlDateConverter;
import com.adeuza.movalysfwk.apache.beanutils.converters.SqlTimeConverter;
import com.adeuza.movalysfwk.apache.beanutils.converters.SqlTimestampConverter;
import com.adeuza.movalysfwk.apache.beanutils.converters.StringConverter;
import com.adeuza.movalysfwk.apache.beanutils.converters.URLConverter;
...
public class ConvertUtilsBean {
	...
	/*
	 * SBE : faire un singleton ?
	 * Pourquoi tous les converter sont-ils instanciés ?
	 */
	
	private static final String TAG = AbstractConverter.class.getName();
...
//    }
     ...
     */
    private transient com.adeuza.movalysfwk.mobile.mf4mjcommons.log.Logger log = Application.getInstance().getLog();
...
//    }
    ...
    public Object convert(String value, Class clazz) {
        ...
        if (log.isDebugLevel()) {
            log.debug(TAG, "Convert string '" + value + "' to class '" +
                      clazz.getName() + "'");
        }
        ...
        if (log.isDebugLevel()) {
            log.debug(TAG, "  Using converter " + converter);
        }
...
//        }
//        if (log.isDebugLevel()) {
//            log.debug(TAG, "Convert String[" + values.length + "] to class '" +
//                      type.getName() + "[]'");
//        }
...
//    }
    ...
    public Object convert(Object value, Class targetType) {
        ...
        if (log.isDebugLevel()) {
            if (value == null) {
                log.debug(TAG, "Convert null value to type '" +
                        targetType.getName() + "'");
            } else {
                log.debug(TAG, "Convert type '" + sourceType.getName() + "' value '" + value +
