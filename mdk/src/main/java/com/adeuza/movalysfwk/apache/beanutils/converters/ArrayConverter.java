...
public class ArrayConverter extends AbstractConverter {
	...
	private static final String TAG = ArrayConverter.class.getName();
    ...
    private List parseElements(Class type, String value) {
        ...
        if (log.isDebugLevel()) {
            log.debug(TAG, "Parsing elements, delimiter=[" + delimiter + "], value=[" + value + "]");
        }
        ...
        try {
            ...
            if (log.isDebugLevel()) {
                log.debug(TAG, list.size() + " elements parsed");
            }
