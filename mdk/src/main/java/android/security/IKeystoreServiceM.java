...
public interface IKeystoreServiceM extends android.os.IInterface {
	...
	public static abstract class Stub extends android.os.Binder implements
		...
		/**
		 * Cast an IBinder object into an android.security.IKeystoreService
		 * interface, generating a proxy if needed.
		 */
		public static IKeystoreServiceM asInterface(
				android.os.IBinder obj) {
			if ((obj == null)) {
				return null;
			}
			android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
			if (((iin != null) && (iin instanceof IKeystoreServiceM))) {
				return ((IKeystoreServiceM) iin);
			}
		...
		public boolean onTransact(int code, android.os.Parcel data,
			...
			case TRANSACTION_list: {
				...
				int _arg1;
				_arg1 = data.readInt();
				String[] _result = this.list(_arg0, _arg1);
				reply.writeNoException();
			...
			case TRANSACTION_generate: {
				...
				if ((0 != data.readInt())) {
					_arg5 = android.security.KeystoreArguments.CREATOR
							.createFromParcel(data);
				} else {
					_arg5 = null;
				}
				int _result = this.generate(_arg0, _arg1, _arg2, _arg3, _arg4,
						_arg5);
				reply.writeNoException();
				reply.writeInt(_result);
				return true;
			...
			case TRANSACTION_generateKey: {
				...
				if ((0 != data.readInt())) {
					_arg1 = android.security.keymaster.KeymasterArguments.CREATOR
							.createFromParcel(data);
				} else {
					_arg1 = null;
				}
				...
				int _result = this.generateKey(_arg0, _arg1, _arg2, _arg3,
						_arg4, _arg5);
				reply.writeNoException();
				reply.writeInt(_result);
				if ((_arg5 != null)) {
					reply.writeInt(1);
					_arg5.writeToParcel(reply,
			...
			case TRANSACTION_getKeyCharacteristics: {
				...
				if ((0 != data.readInt())) {
					_arg1 = android.security.keymaster.KeymasterBlob.CREATOR
							.createFromParcel(data);
				} else {
					_arg1 = null;
				}
				...
				if ((0 != data.readInt())) {
					_arg2 = android.security.keymaster.KeymasterBlob.CREATOR
							.createFromParcel(data);
				} else {
					_arg2 = null;
				}
				...
				int _result = this.getKeyCharacteristics(_arg0, _arg1, _arg2,
						_arg3);
				reply.writeNoException();
				reply.writeInt(_result);
				if ((_arg3 != null)) {
			...
			case TRANSACTION_importKey: {
				...
				int _result = this.importKey(_arg0, _arg1, _arg2, _arg3, _arg4,
						_arg5, _arg6);
				reply.writeNoException();
				reply.writeInt(_result);
				if ((_arg6 != null)) {
					reply.writeInt(1);
					_arg6.writeToParcel(reply,
							android.os.Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
				} else {
					reply.writeInt(0);
				}
			...
			case TRANSACTION_exportKey: {
				...
				if ((0 != data.readInt())) {
					_arg3 = android.security.keymaster.KeymasterBlob.CREATOR
							.createFromParcel(data);
				} else {
					_arg3 = null;
				}
				android.security.keymaster.ExportResult _result = this
						.exportKey(_arg0, _arg1, _arg2, _arg3);
				reply.writeNoException();
				if ((_result != null)) {
					reply.writeInt(1);
			...
			case TRANSACTION_begin: {
				...
				if ((0 != data.readInt())) {
					_arg4 = android.security.keymaster.KeymasterArguments.CREATOR
							.createFromParcel(data);
				} else {
					_arg4 = null;
				}
				...
				android.security.keymaster.OperationResult _result = this
						.begin(_arg0, _arg1, _arg2, _arg3, _arg4, _arg5, _arg6);
				reply.writeNoException();
				if ((_result != null)) {
					reply.writeInt(1);
					_result.writeToParcel(reply,
			...
			case TRANSACTION_finish: {
				...
				_arg3 = data.createByteArray();
				android.security.keymaster.OperationResult _result = this
						.finish(_arg0, _arg1, _arg2, _arg3);
				reply.writeNoException();
				if ((_result != null)) {
					reply.writeInt(1);
					_result.writeToParcel(reply,
		...
		private static class Proxy implements
			...
			public int getState(int userId) throws android.os.RemoteException {
				...
				try {
					...
					mRemote.transact(Stub.TRANSACTION_getState, _data, _reply,
							0);
			...
			@Override
			public int insert(String name, byte[] item, int uid,
			...
			@Override
			public int del(String name, int uid)
					throws android.os.RemoteException {
				android.os.Parcel _data = android.os.Parcel.obtain();
				android.os.Parcel _reply = android.os.Parcel.obtain();
				int _result;
			...
			@Override
			public int exist(String name, int uid)
					throws android.os.RemoteException {
				android.os.Parcel _data = android.os.Parcel.obtain();
				android.os.Parcel _reply = android.os.Parcel.obtain();
				int _result;
			...
			@Override
			public String[] list(String namePrefix, int uid)
					throws android.os.RemoteException {
				android.os.Parcel _data = android.os.Parcel.obtain();
				android.os.Parcel _reply = android.os.Parcel.obtain();
				String[] _result;
			...
			@Override
			public int onUserPasswordChanged(int userId,
					String newPassword)
					throws android.os.RemoteException {
				android.os.Parcel _data = android.os.Parcel.obtain();
				android.os.Parcel _reply = android.os.Parcel.obtain();
				...
				try {
					...
					mRemote.transact(Stub.TRANSACTION_onUserPasswordChanged,
							_data, _reply, 0);
					_reply.readException();
					_result = _reply.readInt();
				} finally {
			...
			@Override
			public int unlock(int userId, String userPassword)
					throws android.os.RemoteException {
				android.os.Parcel _data = android.os.Parcel.obtain();
				android.os.Parcel _reply = android.os.Parcel.obtain();
				int _result;
			...
			@Override
			public int generate(String name, int uid, int keyType,
				...
				try {
					...
					mRemote.transact(Stub.TRANSACTION_generate, _data, _reply,
							0);
					_reply.readException();
					_result = _reply.readInt();
				} finally {
			...
			@Override
			public int import_key(String name, byte[] data, int uid,
					int flags) throws android.os.RemoteException {
				android.os.Parcel _data = android.os.Parcel.obtain();
				android.os.Parcel _reply = android.os.Parcel.obtain();
				int _result;
				try {
					...
					_data.writeInt(uid);
					_data.writeInt(flags);
					mRemote.transact(Stub.TRANSACTION_import_key, _data,
							_reply, 0);
					_reply.readException();
					_result = _reply.readInt();
				} finally {
			...
			@Override
			public int verify(String name, byte[] data,
					byte[] signature) throws android.os.RemoteException {
				android.os.Parcel _data = android.os.Parcel.obtain();
				android.os.Parcel _reply = android.os.Parcel.obtain();
				int _result;
				try {
			...
			@Override
			public byte[] get_pubkey(String name)
					throws android.os.RemoteException {
				android.os.Parcel _data = android.os.Parcel.obtain();
				android.os.Parcel _reply = android.os.Parcel.obtain();
				byte[] _result;
				try {
					_data.writeInterfaceToken(DESCRIPTOR);
					_data.writeString(name);
					mRemote.transact(Stub.TRANSACTION_get_pubkey, _data,
							_reply, 0);
					_reply.readException();
					_result = _reply.createByteArray();
				} finally {
			...
			@Override
			public int grant(String name, int granteeUid)
					throws android.os.RemoteException {
				android.os.Parcel _data = android.os.Parcel.obtain();
				android.os.Parcel _reply = android.os.Parcel.obtain();
				int _result;
			...
			@Override
			public int ungrant(String name, int granteeUid)
					throws android.os.RemoteException {
				android.os.Parcel _data = android.os.Parcel.obtain();
				android.os.Parcel _reply = android.os.Parcel.obtain();
				int _result;
			...
			public long getmtime(String name)
				...
				try {
					_data.writeInterfaceToken(DESCRIPTOR);
					_data.writeString(name);
					mRemote.transact(Stub.TRANSACTION_getmtime, _data, _reply,
							0);
					_reply.readException();
			...
			@Override
			public int duplicate(String srcKey, int srcUid,
					String destKey, int destUid)
					throws android.os.RemoteException {
				android.os.Parcel _data = android.os.Parcel.obtain();
				android.os.Parcel _reply = android.os.Parcel.obtain();
				int _result;
				try {
					...
					mRemote.transact(Stub.TRANSACTION_duplicate, _data, _reply,
							0);
					_reply.readException();
					_result = _reply.readInt();
				} finally {
			...
			@Override
			public int is_hardware_backed(String string)
					throws android.os.RemoteException {
				android.os.Parcel _data = android.os.Parcel.obtain();
				android.os.Parcel _reply = android.os.Parcel.obtain();
				int _result;
				try {
					...
					mRemote.transact(Stub.TRANSACTION_is_hardware_backed,
							_data, _reply, 0);
					_reply.readException();
					_result = _reply.readInt();
				} finally {
			...
			public int clear_uid(long uid) throws android.os.RemoteException {
				...
				try {
					_data.writeInterfaceToken(DESCRIPTOR);
					_data.writeLong(uid);
					mRemote.transact(Stub.TRANSACTION_clear_uid, _data, _reply,
							0);
					_reply.readException();
					_result = _reply.readInt();
				} finally {
			...
			@Override
			public int addRngEntropy(byte[] data)
					throws android.os.RemoteException {
				android.os.Parcel _data = android.os.Parcel.obtain();
				android.os.Parcel _reply = android.os.Parcel.obtain();
				int _result;
				try {
					_data.writeInterfaceToken(DESCRIPTOR);
					_data.writeByteArray(data);
					mRemote.transact(Stub.TRANSACTION_addRngEntropy, _data,
							_reply, 0);
					_reply.readException();
					_result = _reply.readInt();
				} finally {
			...
			public int generateKey(
				...
				try {
					...
					_data.writeInt(uid);
					_data.writeInt(flags);
					mRemote.transact(Stub.TRANSACTION_generateKey, _data,
							_reply, 0);
					_reply.readException();
					_result = _reply.readInt();
					if ((0 != _reply.readInt())) {
			...
			public int getKeyCharacteristics(
				...
				try {
					...
					mRemote.transact(Stub.TRANSACTION_getKeyCharacteristics,
							_data, _reply, 0);
					_reply.readException();
					_result = _reply.readInt();
					if ((0 != _reply.readInt())) {
			...
			public int importKey(
				...
				try {
					...
					_data.writeInt(uid);
					_data.writeInt(flags);
					mRemote.transact(Stub.TRANSACTION_importKey, _data, _reply,
							0);
					_reply.readException();
					_result = _reply.readInt();
					if ((0 != _reply.readInt())) {
			...
			@Override
			public android.security.keymaster.ExportResult exportKey(
					String alias, int format,
					android.security.keymaster.KeymasterBlob clientId,
					android.security.keymaster.KeymasterBlob appId)
					throws android.os.RemoteException {
				android.os.Parcel _data = android.os.Parcel.obtain();
				...
				try {
					...
					mRemote.transact(Stub.TRANSACTION_exportKey, _data, _reply,
							0);
					_reply.readException();
					if ((0 != _reply.readInt())) {
						_result = android.security.keymaster.ExportResult.CREATOR
			...
			@Override
			public android.security.keymaster.OperationResult begin(
					...
					byte[] entropy,
					android.security.keymaster.KeymasterArguments operationParams)
					throws android.os.RemoteException {
				android.os.Parcel _data = android.os.Parcel.obtain();
				android.os.Parcel _reply = android.os.Parcel.obtain();
				...
				try {
					...
					_reply.readException();
					if ((0 != _reply.readInt())) {
						_result = android.security.keymaster.OperationResult.CREATOR
								.createFromParcel(_reply);
					} else {
						_result = null;
					}
			...
			@Override
			public android.security.keymaster.OperationResult update(
					android.os.IBinder token,
					android.security.keymaster.KeymasterArguments params,
					byte[] input) throws android.os.RemoteException {
				android.os.Parcel _data = android.os.Parcel.obtain();
				android.os.Parcel _reply = android.os.Parcel.obtain();
				android.security.keymaster.OperationResult _result;
				try {
			...
			@Override
			public android.security.keymaster.OperationResult finish(
					android.os.IBinder token,
					android.security.keymaster.KeymasterArguments params,
			...
			@Override
			public int abort(android.os.IBinder handle)
					throws android.os.RemoteException {
				android.os.Parcel _data = android.os.Parcel.obtain();
				android.os.Parcel _reply = android.os.Parcel.obtain();
				int _result;
			...
			public boolean isOperationAuthorized(android.os.IBinder token)
				...
				try {
					_data.writeInterfaceToken(DESCRIPTOR);
					_data.writeStrongBinder(token);
					mRemote.transact(Stub.TRANSACTION_isOperationAuthorized,
							_data, _reply, 0);
					_reply.readException();
			...
			public int addAuthToken(byte[] authToken)
				...
				try {
					...
					mRemote.transact(Stub.TRANSACTION_addAuthToken, _data,
							_reply, 0);
					_reply.readException();
					_result = _reply.readInt();
				} finally {
			...
			@Override
			public int onUserAdded(int userId, int parentId)
					throws android.os.RemoteException {
				android.os.Parcel _data = android.os.Parcel.obtain();
				android.os.Parcel _reply = android.os.Parcel.obtain();
				int _result;
				try {
					...
					mRemote.transact(Stub.TRANSACTION_onUserAdded, _data,
							_reply, 0);
					_reply.readException();
					_result = _reply.readInt();
				} finally {
			...
			public int onUserRemoved(int userId)
				...
				try {
					_data.writeInterfaceToken(DESCRIPTOR);
					_data.writeInt(userId);
					mRemote.transact(Stub.TRANSACTION_onUserRemoved, _data,
							_reply, 0);
					_reply.readException();
					_result = _reply.readInt();
				} finally {
	...
	public byte[] get(String name) throws android.os.RemoteException;

	public int insert(String name, byte[] item, int uid, int flags)
			throws android.os.RemoteException;
	...
	public int onUserPasswordChanged(int userId, String newPassword)
			throws android.os.RemoteException;
	...
	public int generate(String name, int uid, int keyType,
						int keySize, int flags, android.security.KeystoreArguments args)
			throws android.os.RemoteException;
	...
	public int verify(String name, byte[] data, byte[] signature)
			throws android.os.RemoteException;
	...
	public int generateKey(String alias,
						   android.security.keymaster.KeymasterArguments arguments,
						   byte[] entropy, int uid, int flags,
						   android.security.keymaster.KeyCharacteristics characteristics)
			throws android.os.RemoteException;

	public int getKeyCharacteristics(String alias,
									 android.security.keymaster.KeymasterBlob clientId,
									 android.security.keymaster.KeymasterBlob appId,
									 android.security.keymaster.KeyCharacteristics characteristics)
			throws android.os.RemoteException;

	public int importKey(String alias,
						 android.security.keymaster.KeymasterArguments arguments,
						 int format, byte[] keyData, int uid, int flags,
						 android.security.keymaster.KeyCharacteristics characteristics)
			throws android.os.RemoteException;
	...
	public android.security.keymaster.OperationResult begin(
			android.os.IBinder appToken, String alias, int purpose,
			boolean pruneable,
			android.security.keymaster.KeymasterArguments params,
			byte[] entropy,
			android.security.keymaster.KeymasterArguments operationParams)
	...
	public android.security.keymaster.OperationResult update(
			android.os.IBinder token,
			android.security.keymaster.KeymasterArguments params, byte[] input)
			throws android.os.RemoteException;

	public android.security.keymaster.OperationResult finish(
			android.os.IBinder token,
			android.security.keymaster.KeymasterArguments params,
			byte[] signature, byte[] entropy) throws android.os.RemoteException;
