...
public class MMProgressBar extends ProgressBar implements ConfigurableVisualComponent<NoneType>, MMIdentifiableView {
	...
	//	/**
	//	 * {@inheritDoc}
	//	 * @see android.widget.ProgressBar#onSaveInstanceState()
	//	 */
	//	@Override
	...
	//	/**
	//	 * {@inheritDoc}
	//	 * @see android.widget.ProgressBar#onRestoreInstanceState(android.os.Parcelable)
	//	 */
	//	@Override
