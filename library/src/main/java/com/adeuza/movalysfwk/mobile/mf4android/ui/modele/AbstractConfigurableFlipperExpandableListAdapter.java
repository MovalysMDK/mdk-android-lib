...
implements FlipperExpandableListAdapter {
	...
	public View getTitleView(int p_iTitlePosition, boolean p_bExpanded, View p_oCurrentRow, ViewGroup p_oParentViewGroup) {
		return this.delegate.getViewByLevel(Level.TITLE, p_bExpanded, p_oCurrentRow, p_oParentViewGroup, p_iTitlePosition);
	}
	...
	public View getChildView(int p_iTitlePosition, int p_iGroupPosition, int p_iChildPosition, boolean p_bLastChild, View p_oCurrentRow, ViewGroup p_oParentViewGroup) {
		return this.delegate.getViewByLevel(Level.CHILD, false, p_oCurrentRow, p_oParentViewGroup, p_iTitlePosition, p_iGroupPosition, p_iChildPosition);
	}
	 ...
	 */
	public ConfigurableListViewHolder createViewHolderChildItem() {
		return new ConfigurableListViewHolder();
	}
	
	public ConfigurableListViewHolder createViewHolderGroupItem(boolean p_bIsExpanded) {
		return new ConfigurableExpandedListViewHolder(p_bIsExpanded);
	...
	public View getGroupView(int p_iTitlePosition, int p_iGroupPosition, boolean p_bExpanded, View p_oCurrentRow, ViewGroup p_oParentViewGroup) {
		return this.delegate.getViewByLevel(Level.GROUP, p_bExpanded, p_oCurrentRow, p_oParentViewGroup, p_iTitlePosition, p_iGroupPosition);
	}
	 ...
	 */
	public ConfigurableListViewHolder createViewHolderTitleItem(boolean p_bExpanded) {
