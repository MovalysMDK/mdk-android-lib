 ...
 *
 */
public class WorkspaceTabDelegate implements TabContentFactory {

	/**
	 * la base du nom de l'attribut pour récupérer les onglets
	 */
	//private final static String CONF_TAB_ATTRIBUTE = "workspacetab";
	
	/**
	 * la base du nom de l'attribut pour récupérer le nombre d'onglets
	 */
	//private final static String CONF_TAB_SIZE_ATTRIBUTE = "workspacetabsize";
	
	/**
	 * Workspace layout
	 */
	private MMWorkspaceLayout workspaceLayout;
	 ...
	 * @param p_oView
	 */
	public WorkspaceTabDelegate( MMWorkspaceLayout p_oView ) {
