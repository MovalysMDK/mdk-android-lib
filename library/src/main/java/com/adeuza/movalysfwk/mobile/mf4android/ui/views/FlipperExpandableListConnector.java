...
public class FlipperExpandableListConnector extends BaseExpandableListAdapter {
	 ...
	 * </p>
	 *
	 * @param Map<Integer, ArrayList<GroupMetadata>>
	 * 		The current ID Title
	 */
	public void setTitleExpandableList(
			Map<Integer, ArrayList<GroupMetadata>> p_oTitleExpandableList) {
	 ...
	 */
	public ArrayList<GroupMetadata> getGoupExpandableList(int p_iCurrentTitleID) {
	...
	static class GroupMetadata implements Parcelable {
		...
		private GroupMetadata(int p_iCurrentID, boolean p_isExpanded) {
