...
public class MMTextView extends TextView implements ConfigurableVisualComponent<String>, MMIdentifiableView, InstanceStatable {
	...
	public void superOnRestoreInstanceState(Parcelable p_oState) {
		...
		configurationSetValue(r_oBundle.getString("textview"));
	}
