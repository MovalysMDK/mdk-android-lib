...
import com.adeuza.movalysfwk.mobile.mf4android.ui.views.MMDurationPickerGroup;
...
public class MMDurationPickerDialogFragment extends MMDialogFragment implements OnClickListener, OnDateChangedListener, OnDismissListener {
	 ...
	 */
	private MMDurationPickerGroup m_uiPickerGroup;
	...
	public Dialog onCreateDialog(Bundle p_oSavedInstanceState) {
		...
		m_uiPickerGroup = (MMDurationPickerGroup) o_uiContentView.findViewById(oApplication.getAndroidIdByRKey(AndroidApplicationR.component_durationpicker__picker));
		m_uiPickerGroup.configurationSetValue(m_lTemporaryValue);
		m_uiPickerGroup.configurationEnabledComponent() ;
	...
	private void onValidateClick() {
		this.m_lTemporaryValue = m_uiPickerGroup.configurationGetValue();
	}
