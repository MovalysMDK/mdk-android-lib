...
public class MMImageView extends ImageView implements ConfigurableVisualComponent<Integer>, MMIdentifiableView, InstanceStatable {
	 ...
	 */
	@Override
	public void configurationSetValue(Integer p_iImageId) {
		if(
			p_iImageId != null && !p_iImageId.equals(this.configurationGetValue()) 
			|| p_iImageId == null && this.configurationGetValue() != null
		) {
			if (p_iImageId==null || p_iImageId == NO_IMAGE ){
				this.setVisibility(GONE);
			}else{
				if (this.getVisibility()!= VISIBLE){
					this.setVisibility(VISIBLE);
				}
				this.setImageResource(p_iImageId);
			}
		}
	}
