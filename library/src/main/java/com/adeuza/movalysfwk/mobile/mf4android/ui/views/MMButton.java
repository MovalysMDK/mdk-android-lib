...
public class MMButton extends Button implements ConfigurableVisualComponent<NoneType>, MMIdentifiableView, InstanceStatable {
	 ...
	 */
	public MMButton(Context p_oContext) {
		super(p_oContext);
		if(!isInEditMode()) {
	...
	public MMButton(Context p_oContext, AttributeSet p_oAttrs) {
		...
		//completed by the onFinishInflate callback method
	}
