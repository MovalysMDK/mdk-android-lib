...
/**
 * Processes to execute in the {@link AbstractConfigurableFlipperExpandableListAdapter} for the child view
...
public class FlipperAdapterChild<
	...
	public ConfigurableListViewHolder getViewHolder(
			AbstractConfigurableFlipperExpandableListAdapter<ITEM, SUBITEM, SUBSUBITEM, SUBSUBITEMVM, SUBITEMVM, ITEMVM> p_oAdapter,
			boolean p_bExpanded) {
		return p_oAdapter.createViewHolderChildItem();
	}
	...
	public MasterVisualComponent<?> getCompositeComponent(
		...
		iLayout = p_oAdapter.getConfigurableChildLayoutId();
	...
	public void wrapCurrentView(
		...
		p_oAdapter.wrapCurrentChildView(p_oCurrentRow, (SUBSUBITEMVM) p_oCurrentVM, p_oPositions[0], p_oPositions[1], p_oPositions[2]);
	}
}
