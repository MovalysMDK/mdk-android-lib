...
public class MMRelativeLayout extends RelativeLayout implements ConfigurableLayoutComponent<NoneType>, MMIdentifiableView {

	/** configurable view delegate */
	protected AndroidConfigurableLayoutComponentDelegate<NoneType> aivDelegate = null;
	 ...
	 */
	public MMRelativeLayout(Context p_oContext, AttributeSet p_oAttrs) {
		super(p_oContext, p_oAttrs);
		if(!isInEditMode()) {
			this.aivDelegate = new AndroidConfigurableLayoutComponentDelegate<NoneType>(this);
		}
	}
	 ...
	 */
	public MMRelativeLayout(Context p_oContext) {
		super(p_oContext);
