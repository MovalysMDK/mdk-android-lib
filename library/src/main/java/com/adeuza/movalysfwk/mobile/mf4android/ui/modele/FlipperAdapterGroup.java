...
/**
 * Processes to execute in the {@link AbstractConfigurableFlipperExpandableListAdapter} for the group view
...
public class FlipperAdapterGroup<
	...
	public ConfigurableListViewHolder getViewHolder(
			AbstractConfigurableFlipperExpandableListAdapter<ITEM, SUBITEM, SUBSUBITEM, SUBSUBITEMVM, SUBITEMVM, ITEMVM> p_oAdapter,
			boolean p_bExpanded) {
		return p_oAdapter.createViewHolderGroupItem(p_bExpanded);
	}
	...
	public MasterVisualComponent<?> getCompositeComponent(
		...
		iLayout = p_oAdapter.getConfigurableGroupLayoutId();
	...
	public void wrapCurrentView(
		...
		p_oAdapter.wrapCurrentGroupView(p_oCurrentRow, (SUBITEMVM) p_oCurrentVM, p_oPositions[0], p_oPositions[1]);
	}
}
