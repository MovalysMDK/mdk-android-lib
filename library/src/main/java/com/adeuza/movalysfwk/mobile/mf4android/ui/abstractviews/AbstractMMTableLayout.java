 ...
 */
public abstract class AbstractMMTableLayout<VALUE> extends TableLayout implements ConfigurableLayoutComponent<VALUE>, MMIdentifiableView, InstanceStatable {
	 ...
	 */
	public AbstractMMTableLayout(Context p_oContext, AttributeSet p_oAttrs) {
	 ...
	 */
	public AbstractMMTableLayout(Context p_oContext) {
		super(p_oContext);
		if(!isInEditMode()) {
			this.aivDelegate = new AndroidConfigurableLayoutComponentDelegate<>(this);
		}
