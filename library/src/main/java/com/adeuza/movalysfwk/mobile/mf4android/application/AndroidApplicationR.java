...
public enum AndroidApplicationR implements ApplicationR {
	...
	/** R.id.fwk_screen_mire_test */
	fwk_screen_mire_test(ApplicationRGroup.ID, "screen_mire_test"),
	/** R.id.mire_metrics_density */
	mire_metrics_density(ApplicationRGroup.ID, "mire_metrics_density"),
	/** R.id.mire_metrics_densitydpi */
	mire_metrics_densitydpi(ApplicationRGroup.ID, "mire_metrics_densitydpi"),
	/** R.id.mire_metrics_scaled_density */
	mire_metrics_scaled_density(ApplicationRGroup.ID, "mire_metrics_scaled_density"),
	/** R.id.mire_metrics_hight_pixels */
	mire_metrics_hight_pixels(ApplicationRGroup.ID, "mire_metrics_hight_pixels"),
	/** R.id.mire_metrics_width_pixels */
	mire_metrics_width_pixels(ApplicationRGroup.ID, "mire_metrics_width_pixels"),
	/** R.id.mire_metrics_xdpi */
	mire_metrics_xdpi(ApplicationRGroup.ID, "mire_metrics_xdpi"),
	/** R.id.mire_metrics_ydpi */
	mire_metrics_ydpi(ApplicationRGroup.ID, "mire_metrics_ydpi"),
	...
	/** R.id.component_double__double__label */
	component_double__double__label(ApplicationRGroup.ID, "component_double__double__label"),
...
//	component_double_dialog__negative__button(ApplicationRGroup.ID, "component_double_dialog__negative__button"),
	...
	/** R.id.component_duration__duration__label */
	component_duration__duration__label(ApplicationRGroup.ID, "component_duration__duration__label"),
	...
	/** R.id.component_datetime__datetime__label */
	component_datetime__datetime__label(ApplicationRGroup.ID, "component_datetime__datetime__label"),
	...
	/** R.id.component_email__email__label */
	component_email__email__label(ApplicationRGroup.ID, "component_email__email__label"),
	...
	/** R.id.component_email__email__edit */
	component_email__email__edit(ApplicationRGroup.ID, "component_email__email__edit"),
	...
	/** R.id.component_multiautocomplete__editText__label */
	component_multiautocomplete__editText__label(ApplicationRGroup.ID, "component_multiautocomplete__editText__label"),
	...
	/** R.id.component_multiautocomplete__editText__label */
	component_edittextdialog__textview__label(ApplicationRGroup.ID, "component_edittextdialog__textview__label"),
	/** R.id.component_multiautocomplete__editText__edit */
	...
	/** R.id.component_phonenumber__phonenumber__label */
	component_phonenumber__phonenumber__label(ApplicationRGroup.ID, "component_phonenumber__phonenumber__label"),
	...
	/** R.id.component_phonenumber__phonenumber__label */
	component_url__url__label(ApplicationRGroup.ID, "component_url__url__label"),
	/** R.id.component_phonenumber__phonenumber__value */
	...
	/** R.id.component_position__position__label */
	component_position__position__label(ApplicationRGroup.ID, "component_position__position__label"),
	...
	/** R.id.component_scanbarcode__scanbarcode__label */
	component_scanbarcode__scanbarcode__label(ApplicationRGroup.ID, "component_scanbarcode__scanbarcode__label"),
...
//	custom_dialog_cancel_button(ApplicationRGroup.ID, "custom_dialog_cancel_button"),
	...
	component_doublepicker__double__label(ApplicationRGroup.ID, "component_doublepicker__double__label"),
	...
	component_durationpicker__duration__label(ApplicationRGroup.ID, "component_durationpicker__duration__label"),
