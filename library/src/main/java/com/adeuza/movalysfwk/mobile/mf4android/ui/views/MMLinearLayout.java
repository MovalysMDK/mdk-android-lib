...
public class MMLinearLayout extends LinearLayout implements ConfigurableLayoutComponent<NoneType>, MMIdentifiableView {
	 ...
	 */
	public MMLinearLayout(Context p_oContext, AttributeSet p_oAttrs) {
	 ...
	 */
	public MMLinearLayout(Context p_oContext) {
		super(p_oContext);
		if (!isInEditMode()){
			this.aivDelegate = new AndroidConfigurableLayoutComponentDelegate<>(this);
			setDrawingCacheEnabled(true);
