...
/**
 * <p>TableRow widget used in the Movalys Mobile product for Android</p>
 *
 * <p>Copyright (c) 2010
 * <p>Company: Adeuza
 *
...
public class MMTableRow extends TableRow implements ConfigurableVisualComponent<NoneType>, MMIdentifiableView {

	/** configurable view delegate */
	private AndroidConfigurableVisualComponentDelegate<NoneType> aivDelegate = null;

	/**
	 * Constructs a new MMTableRow
	 * @param p_oContext the context to use
	 * @see TableRow#TableRow(Context)
	 */
	public MMTableRow(Context p_oContext) {
		super(p_oContext);
		if(!isInEditMode()) {
	 ...
	 * @see TableRow#TableRow(Context, AttributeSet)
	 */
	public MMTableRow(Context p_oContext, AttributeSet p_oAttrs) {
