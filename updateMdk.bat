...
REM Retrieve resources from apklib
call mvn -B -q archetype:generate -DarchetypeGroupId=com.adeuza.movalysfwk -DarchetypeArtifactId=mdk-apklib-template -DarchetypeVersion=%MF4A_VERSION% -DgroupId=com.adeuza.movalysfwk -DartifactId=mdkapklib -Dversion=%MF4A_VERSION%

xcopy /y "mdkapklib\mdk-ressources\res" "..\mdk\src\main\res\" /e
