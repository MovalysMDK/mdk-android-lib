...
public class MMWorkspaceMasterDetailFragmentLayout extends AbstractBaseWorkspaceFragmentLayout<VMTabConfiguration> 
	implements ComponentReadableWrapper<VMTabConfiguration>, ComponentWritableWrapper<VMTabConfiguration> {

	/**
	 * Constructs a new MMWorkspaceMasterDetailFragmentLayout
	 * Call super with Class = VMTabConfiguration.class
	 * @param p_oContext the context to use
	 * @see AbstractBaseWorkspaceFragmentLayout#AbstractBaseWorkspaceFragmentLayout(Context, Class)
	 */
	 ...
	 * @see AbstractBaseWorkspaceFragmentLayout#AbstractBaseWorkspaceFragmentLayout(Context, AttributeSet, Class)
	 */
