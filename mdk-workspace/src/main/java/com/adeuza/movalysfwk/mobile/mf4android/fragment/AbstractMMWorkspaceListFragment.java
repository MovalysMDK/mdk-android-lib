...
public abstract class AbstractMMWorkspaceListFragment extends AbstractMMListFragment {
	...
	protected void doAfterInflate(ViewGroup p_oRoot) {
		...
		this.mWorkspaceHandler = new WorkspaceListHandler(this.getListViewId(), this.mAdapter);
	...
	public static class WorkspaceListHandler implements Serializable {
		 ...
		 * Adapter
		 */
		private Object adapter = null; // TODO : passer sur MDKBaseAdapter
		 ...
		 */
		public WorkspaceListHandler(int p_iResourceId, Object p_oAdapter) { // TODO : passer sur MDKBaseAdapter
		 ...
		 */
		public Object getAdapter() { // TODO : passer sur MDKBaseAdapter
			return this.adapter;
		}
